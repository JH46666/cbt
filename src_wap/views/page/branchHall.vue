...
export default {
  ...
  created() {
      ...
      case "wap-seasonal":
        ...
        this.$store.dispatch("getBlock", "wap-seasonal").then(res => {
          if (res.data.htmlText.trim() != "") {
            ...
            this.bannerImg =
              '<img src="//img0.oteao.com/hallBanner/yjhc.jpg" alt="">';
          }
        });
        break;
      case "wap-smallcrowd":
        ...
        this.$store.dispatch("getBlock", "wap-smallcrowd").then(res => {
          if (res.data.htmlText.trim() != "") {
            ...
            this.bannerImg =
              '<img src="//img0.oteao.com/hallBanner/xzg.jpg" alt="">';
          }
        });
        break;
      case "wap-poop":
        ...
        this.$store.dispatch("getBlock", "wap-poop").then(res => {
          if (res.data.htmlText.trim() != "") {
            ...
            this.bannerImg =
              '<img src="//img0.oteao.com/hallBanner/pzwh.jpg" alt="">';
          }
        });
        break;
      case "wap-afir":
        ...
        this.$store.dispatch("getBlock", "wap-afir").then(res => {
          if (res.data.htmlText.trim() != "") {
            ...
            this.bannerImg =
              '<img src="//img0.oteao.com/hallBanner/mzg.jpg" alt="">';
          }
        });
        break;
      case "wap-newproduct":
        ...
        this.$store.dispatch("getBlock", "wap-newproduct").then(res => {
          if (res.data.htmlText.trim() != "") {
            ...
            this.bannerImg =
              '<img src="//img0.oteao.com/hallBanner/xpg.jpg" alt="">';
          }
        });
        break;
      default:
    ...
    this.$api.get(
      "/oteao/productCollection/getCollectionDetail",
      {
        device: "WAP",
        sysId: 1,
