    ...
    infinite-scroll-distance="10">
        <div class="hd">
            <div class="left">
                ...
                <div class="integral-num">{{ member.totalAmount | toFix2 }}</div>
            </div>
            <div class="right">
            ...
            <div class="item-wrap" v-else>
                <div class="item" v-for="(item,i) in list">
                    <div class="left">
                        ...
                        <div class="resdue">余额：{{ item.afterMoney | toFix2 }}</div>
                    </div>
                    <div class="right">
                        <div class="count">{{ item.afterMoney > item.beforeMoney ? '+' : '' }}{{ item.alterMoney | toFix2 }}</div>
...
<script>
    ...
    export default {
        ...
        created() {
            // 设置title
            this.$store.commit('SET_TITLE','账户余额');
