                    ...
                    <mt-cell v-for="(item,index) in orderList" :key="index">
                        ...
                        <div class="order_foot">
                            ...
                            <div class="btn_wrapper">
                                ...
                                <mt-button plain v-if="(item.orderStatus === 'DELIVERED' || item.orderStatus === 'CBT_BUYER') && item.sellerOrgId!=null&&!item.subOrderSize" class="pay_now" @click.native="confrimMethod(item.orderNo)">确认收货</mt-button>
